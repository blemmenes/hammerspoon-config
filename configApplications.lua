return {
  ['com.microsoft.Outlook'] = {
    ...
    -- layouts = {
    --   {nil, hs.screen'Built%-in':name(), hs.layout.maximized}
    -- }
  },
  ['md.obsidian'] = {
    ...
    -- layouts = {
    --   {nil, hs.screen'Acer':name(), hs.geometry.rect(0.6667, 0, .3334, 1)} -- right third
    -- }
  },
  ['com.brave.Browser.app.cinhimbnkkaeohfgghhklpknlkffjgod'] = {
    ...
    tags = {'personal'},
    -- layouts = {
    --   {nil, hs.screen'Built%-in':name(), hs.layout.right50}
    -- }
  },
  ['com.tinyspeck.slackmacgap'] = {
    ...
    tags = {'communication'},
    -- layouts = {
    --   {nil, hs.screen'Acer':name(), hs.geometry.rect(0.3334, 0, 0.3334, 1)} -- middle third
    -- }
  },
  ['com.webcatalog.juli.zendesk'] = {
    ...
    -- tags = {'research', 'notes'},
    -- layouts = {
    --   {nil, hs.screen'Acer':name(), hs.geometry.rect(0, 0, .3334, 1)} -- left third
    -- }
  },
